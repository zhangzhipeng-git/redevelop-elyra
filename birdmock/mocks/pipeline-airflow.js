module.exports = {
  ...
  '/elyra/pipeline/APACHE_AIRFLOW/properties': () => {
    return {
      type: 'object',
      properties: {
        name: {
  ...
  '/elyra/pipeline/components/APACHE_AIRFLOW/python-script/properties': () => {
    return {
      type: 'object',
      properties: {
        label: {
  ...
  '/elyra/pipeline/components/APACHE_AIRFLOW/r-script/properties': () => {
    return {
      type: 'object',
      properties: {
        label: {
